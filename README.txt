Name: Brahmajit Mohapatra

DATA VISUALIZATION (Tableau)

CASE: You are working as an analyst in the laundry pickup services start-up
company. You have to analyse different insights for the same and suggest the 
recommendations which will help the organization to take better decisions.

DATASET: [Dataset- start up expansion] 
